...
internal sealed class CancelarSesionCommandHandler
    : IRequestHandler<CancelarSesionCommand, Result<Guid>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        sesion.Cancelar(command.Motivo);
