...
**Fuentes:** Fase 1 [iter-02](../fase-1/iter-02-registrar-equipo.md), **HU-13**, **RB-02**, **RB-03**

---

## Objetivo

Orquestar `Sesion.RegistrarEquipo` devolviendo `EquipoId` y `CodigoAcceso` al operador.
...
| `RegistrarEquipoResult` | `EquipoId` + `CodigoAcceso` |
...
| ID | Criterio | Test |
|----|----------|------|
| RB-02-02-01 | Nombre único → equipo + código | `Handle_CuandoSesionExisteYNombreUnico_*` |
