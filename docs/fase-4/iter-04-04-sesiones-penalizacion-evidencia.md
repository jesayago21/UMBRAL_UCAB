...
- `TestAuthHandler`: claim `EquipoParticipante` para probar evidencias en Development/Testing
...
- Evidencias: rol `EquipoParticipante` (spec §7.2). En 04-05b el JWT de equipo reemplazará el claim de prueba.
