...
public sealed class SesionUnirseParticipantePersistenceTests(PostgresFixture fixture)
{
    [Fact]
    public async Task CrearSesionYUnirseParticipante_EnDosPasos_PersisteParticipante()
    {
        ...
        var reloaded = await verifyDb.ParticipantesSesion
            .AsNoTracking()
